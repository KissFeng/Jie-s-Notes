...
export default withMermaid(
  defineConfig({
    ...
    themeConfig: {
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Claude 封号事件的追踪术', link: '/docs/日常吐槽/claude-封号事件的离谱追踪术' },
            { text: 'Claude 强制实名认证', link: '/docs/日常吐槽/claude-强制实名认证' }
          ]
        },
        {
          text: '只有我自己看得明白',
          ...
          items: [
            ...
            { text: 'Clash Verge Rev 链式代理完整配置手册', link: '/docs/只有我自己看得明白/clash-verge-chain-proxy' }
          ]
        }
      ],
      ...
      footer: {
        copyright: 'Copyright © 2026-present Power | <a href="https://beian.miit.gov.cn/" target="_blank">冀ICP备2026020091号-1</a>'
      }
    }
  })
)
